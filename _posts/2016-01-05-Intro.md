...
The results of the analysis on a larger data set look like the following. The first image shows the estimated probability
density of the duration of the bus line 12 from Hallila, split into the fastest quantile, the slowest quantile and the rest.
The second diagram shows a plot of the estimated density functions for the scheduled start hour of the trips in the
fastest (in red color) and slowest quantiles. The fairly obvious conclusion is that the trips starting at around the
beginning and end of the workday are the slowest, whereas the evening and mid-day bus trips are typically faster.
The third diagram shows the distribution of temperatures for the same quantiles. Interestingly,
the distribution of the trips in the fastest quantile seems to be bi-modal. It's a bit difficult to say without more data
and a deeper analysis if this is a real finding or just an anomaly.

<div class="row">
	<div class="col-md-4">
		<img src="/BigDataSpark/assets/bus12-distribution.png" height="400" width="400" />
	</div>
	<div class="col-md-4">
		<img src="/BigDataSpark/assets/bus12-top-bottom-start.png" height="400" width="400"/>
	</div>
	<div class="col-md-4">
		<img src="/BigDataSpark/assets/bus12-temp-top-bottom.png" height="400" width="400"/>
	</div>
</div>
...
this is still an area where big data tools excel. Scalability (of the analysis) and a more flexible programming model
are the key differentiators, but sometimes at the expense of additional complexity.
