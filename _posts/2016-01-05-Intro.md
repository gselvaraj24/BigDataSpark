...
<div  class="center"><a href="http://lissu.tampere.fi/"><img src="/BigDataSpark/assets/2016-01-05-Intro-Buses.png" width="600"/></a></div>
...
density of the duration of the bus line 12 from Hallila, split into the bottom quantile (the fastest journeys),
...
* **Driver program.** The driver is responsible for loading Spark Context, which provides utility functions for data I/O.
